//
//  MWPBTimeHistoryTableViewController.m
//  MW
//
...
#import "MWPBTimeHistoryTableViewController.h"

@interface MWPBTimeHistoryTableViewController ()

@end

@implementation MWPBTimeHistoryTableViewController {
...
- (IBAction)selectExercise:(id)sender {
    ...
    bestTime = [db getBestTimePB: _exeDTO.pKExerciseTypeID];
...
//    [self performSegueWithIdentifier: @"ToPBChartSegue" sender: self];
//}
