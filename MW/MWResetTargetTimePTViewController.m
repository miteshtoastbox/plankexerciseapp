//
//  MWResetTargetTimePTViewController.m
//  MW
//
...
@interface MWResetTargetTimePTViewController ()

@end


@implementation MWResetTargetTimePTViewController
...
- (IBAction)exerciseImageButtonPressed:(id)sender {
    ...
    DataAccess *db = [[DataAccess alloc] init];
    bool success = [db clearTargetTime: _exe.pKExerciseTypeID];
